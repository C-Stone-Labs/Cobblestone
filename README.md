...
1. Repoyu klonlayın:
```bash
git clone [https://github.com/kullanici-adi/cobblestone.git](https://github.com/kullanici-adi/cobblestone.git)
cd cobblestone
...
Bu komut mimariye göre optimize edilmiş tek bir APK dosyası üretir. Dosya konumu:
